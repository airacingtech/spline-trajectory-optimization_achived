...
out_file_path = 'LVMS_MAIN_OUTTER_2024_enu(2).csv'
in_file_path = 'LVMS_MAIN_INNER_2024_enu(2).csv'
centerline_file_path = 'centerline_lvms_no_bank_svl_enu_smoothed.csv'
