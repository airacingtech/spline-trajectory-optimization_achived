...
def main(ttl_dir : pathlib.Path):
    for ttl_path in ttl_dir.glob("**/*.csv"):
        print("adding normal to", ttl_path)
        first_line = ''
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", help="Path to the ttls directory", type=pathlib.Path, default=pathlib.Path("/home/adith/test/spline-trajectory-optimization/helper_scripts.py/normals"))
